...
export default function GestionAsistentes() {
    ...
    const verDetallesAsistente = (asistente) => {
        console.log('Abriendo modal para:', asistente); // Debug
    ...
    return (
        <>
            ...
            {/* Modal FUERA del layout-container para evitar problemas de posicionamiento */}
            {modalVisible && asistenteSeleccionado && (
                <div className="modal-overlay-asistente" onClick={cerrarModal}>
